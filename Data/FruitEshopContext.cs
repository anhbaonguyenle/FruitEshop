...
namespace FruitEshop.Data;

public partial class FruitEshopContext : DbContext
{
    public FruitEshopContext()
    {
    }

    public FruitEshopContext(DbContextOptions<FruitEshopContext> options)
        : base(options)
    {
    }
