...
namespace FruitEshop.Controllers
{
    ...
    {
        private readonly FruitEshopContext _context;

        public HangHoasController(FruitEshopContext context)
        {
            _context = context;
        }
        ...
        {
            var fruitEshopContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await fruitEshopContext.ToListAsync());
        }
